...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', default="config/config_finetune_davis.json", type=str,
                        help='config file path (default: None)')
    parser.add_argument('--dataset_config', default="dataset_configs/FVI_all_masks_my.json", type=str,
